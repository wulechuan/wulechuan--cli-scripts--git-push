 ...
 * @param {object}                        配置项集.诸内部功能各自之配置项集.自动配置_vscode_tasksJSON.视作须为其安装本工具集的_npm_项目的根文件的完整路径
 * @param {object}                        配置项集.诸内部功能各自之配置项集.自动配置_vscode_tasksJSON.视作_dotvscode_文件夹的文件夹之相对路径
 ...
 * @param {object}                        配置项集.诸内部功能各自之配置项集.在采用该工具集的项目中自动构建命令行脚本集.视作须为其安装本工具集的_npm_项目的根文件的完整路径
 * @param {object}                        配置项集.诸内部功能各自之配置项集.在采用该工具集的项目中自动构建命令行脚本集.用于容纳发布的各命令行脚本的文件树之根文件夹之完整路径
 * @param {string}                        配置项集.诸内部功能各自之配置项集.在采用该工具集的项目中自动构建命令行脚本集.本工具集随附命令行应用范本集文件夹之相对路径
 * @param {string}                        配置项集.诸内部功能各自之配置项集.在采用该工具集的项目中自动构建命令行脚本集.用于研发阶段的命令行工具_这一文件夹之相对路径
...
module.exports = function 本工具集一切自动安装与配置任务之内部总接口 ({
    ...
    return Promise.all([
        ...
        // 为了日志清晰、有序、易读，我最终还是舍弃了 Promsie.all 的做法，改为顺次执行各功能。
        return Promise.resolve().then(() => {
            return 内部功能之自动配置_vscode_tasksJSON({
                粉笔工具,
                路径工具,
                文件系统工具之扩展版,
                微软_jsonc_处理机,
            ...
            return 内部功能之在采用该工具集的项目中自动构建命令行脚本集({
                粉笔工具,
                路径工具,
                文件系统工具之扩展版,
